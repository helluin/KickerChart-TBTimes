...
function drawCharts(container_width) {
    ...
    d3.json("teamScoring.json", function (data) {


        var chartTouchdown = d3.select("#iframeContainer").append("svg")
        ...
        var teamName = d3.select(document.getElementById("TeamName"));
        var touchdowns = d3.select(document.getElementById("Touchdowns"));
        var winPercentage = d3.select(document.getElementById("WinPercentageTD"));
